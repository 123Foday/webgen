...
import { deployToVercel, publishToGitHub } from "../utils/services.js";
  ...
  return async (req, res, next) => {
    try {
      ...
      if (!project.html || project.html.length < 100) {
        return res.status(400).json({ error: "Project has no generated HTML yet." });
      }
...
// to host site live using the vercel token
