...
function brandName(p) {
  const t = (p || "")
    ...
    .trim();
  return (t || "WebGen Studio").slice(0, 32);
}
...
<footer>
  ...
  <div class="foot-bottom"><span>© ${new Date().getFullYear()} ${brand}. All rights reserved.</span><span>Built with WebGen · ${c.name} edition</span></div>
</footer>
