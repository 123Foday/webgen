export const builderPageStyles = {
  ...
  visualEditorButton:
    "flex items-center gap-1.5 px-4 py-2 rounded-lg bg-indigo-500/15 border border-indigo-500/30 text-indigo-300 text-[13px] font-semibold cursor-pointer transition hover:bg-indigo-500/25",
