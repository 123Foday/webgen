    ...
    <section className={s.heroSection}>
      ...
      <div className={s.heroInner}>
        <button onClick={() => navigate("/pricing")} className={s.trialBadge}>
          ...
          <span className={s.trialBadgeText}>Try 30 days free trials</span>
        ...
        <p className={s.heroSub}>
          Create, customize and publish websites faster than ever before with the
          WebGen site builder.
        </p>
      ...
      <div className={s.featuresInner}>
        <div className={s.featuresHeader}>
          ...
          <p className={s.featuresSub}>
            ...
            website - without leaving your browser.
          </p>
        </div>
...
function CTA() {
  ...
  const ctaText = isAuthed ? "Start a new site" : "Create you first site";
      ...
      <div className={s.ctaBg} />
        <div className={s.ctaInner}>
          <div className={s.ctaFreeBadge}>
            <Sparkle className={s.ctaFreeBadgeIcon} /> 20 free credits on 
            signup
          </div>
          ...
          <p className={s.ctaSub}>
            Your first 20 credits are on us - enough for 4 new sites or 10 
