...
// This is One Card UI for the setting page 
...
export default function SettingsPage() {
  ...
  // This will merge the given fields into shared UI
  function setStatePatch(p) {
    setState((s) => ({ ...s, ...p }));
  }

  // shared save flow for validating, show saving run the action
              ...
              <div className={s.deleteInner}>
                ...
                <div>
                  ...
                  <p className={s.deleteDesc}>
                    Permanently delete your mintsite account and all generated
