...
// it handles stripe success-return URL
// then we hit /verify-session
function StripeReturnBanner() {
  ...
  // check for sessionId and return the output
  useEffect(() => {
    if (!sessionId) return;
    let mounted = true;
...
// it tracks buying status
// to start checkout session
...
// It is for the credits packages
...
// banner promoting the 20 free credits UI
